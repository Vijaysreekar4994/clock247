...
function App() {
  ...
  // https://app.exchangerate-api.com/dashboard/confirmed vijaysreekar4994@gmail.com regular formula.
  // const fetchExchangeRate = async () => {
  //   const response = await fetch('/api/exchange-rate');
  //   // const response = await fetch('https://api.exchangerate-api.com/v4/latest/EUR');
  //   const data = await response.json();
  //   console.log('fetchExchangeRate :',data)
  ...
  return (
    <div className='App'>
      ...
      <div className='content'>
        ...
        <div className={'exchangeRate'}>{exchangeRate} INR</div> */}
